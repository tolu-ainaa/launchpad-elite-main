const cols = [
  ...
  { h: "Lumen Store", l: ["Find a Store", "Today at Lumen", "Group Orders"] },
  { h: "About Lumen", l: ["Newsroom", "Leadership", "Careers", "Contact"] },
];
    ...
    <footer className="border-t border-border bg-secondary/60 text-xs text-muted-foreground">
      <div className="mx-auto max-w-5xl px-6 py-10">
        <p className="mb-8 leading-relaxed">
          Pricing shown is a demo. Lumen is a fictional product built to demonstrate a clean storefront design.
        </p>
        ...
        <div className="mt-10 flex flex-col gap-2 border-t border-border pt-6 md:flex-row md:justify-between">
          <p>Copyright © 2026 Lumen Inc. All rights reserved.</p>
